...
var _confettiJs = require("./partials/confetti.js"); // import './partials/bedroom.js';
 // import './partials/boids.js';

},{"./styles.css":"7N9bM","./partials/sidebar.js":"7TxDz","./partials/confetti.js":"faUyi"}],"7N9bM":[function() {},{}],"7TxDz":[function(require,module,exports) {
...
},{}],"faUyi":[function(require,module,exports) {
    ...
    var t = function() {
        ...
        function e(n) {
            ...
            if (this.bursts = [], this.setCount = function(t) {
                ...
                var n;
                r.element = document.getElementById(t), null === (n = r.element) || void 0 === n || n.addEventListener("load", function(t) {
        ...
        return t.generateVelocity = function() {
            var t = Math.random() - 0.5, i = Math.random() - 0.7, n = Math.sqrt(t * t + i * i);
