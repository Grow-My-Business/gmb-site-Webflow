...
})({"cRheU":[function(require,module,exports) {
...
Author: Ben Elwood
Date Created: 14th Sept 2023
Last Modified: 14th Sept 2023 6:12 PM

*/ // import '@splidejs/splide/css/core';
// import '@splidejs/splide/js';
var _stylesCss = require("./styles.css");
var _sidebarJs = require("./partials/sidebar.js");
var _sliderJs = require("./partials/slider.js");
var _confettiOriginalJs = require("./partials/confetti-original.js");
var _generalJs = require("./partials/general.js"); // import './partials/bedroom.js';
 // import './partials/boids.js';

},{"./styles.css":"7N9bM","./partials/sidebar.js":"7TxDz","./partials/slider.js":"a05ij","./partials/confetti-original.js":"fZ0yD","./partials/general.js":"arE4d"}],"7N9bM":[function() {},{}],"7TxDz":[function(require,module,exports) {
        ...
        if (children.length > 0) {
            children.forEach((child)=>{
                ...
                if (parent_id !== "") {
                    ...
                    if (!parent.parentElement.classList.contains("has-children")) parent.parentElement.classList.add("has-children");
                }
            });
            //
        ...
        function init_tutorial_sidebar_search() {
            ...
            input.addEventListener("input", ()=>{
                ...
                dropdowns.forEach((dropdown)=>{
                    ...
                    if (query.length > 2) {
                        if (dropdown.innerHTML.toLowerCase().indexOf(query) === -1) dropdown.classList.add("disabled");
                        else {
                            dropdown.classList.remove("disabled");
                            const links = dropdown.querySelectorAll(".tutorial-link");
                            links.forEach((link)=>{
                                if (link.innerText.toLowerCase().indexOf(query) === -1 && children_wrap.innerText.toLowerCase().indexOf(query) !== -1) link.classList.add("disabled");
...
},{}],"a05ij":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", function() {
    if (document.querySelector(".splide")) var splide = new (0, _splideDefault.default)(".splide", {
        type: "loop",
        autoWidth: true,
        arrows: true,
        pagination: false,
...
},{}],"fZ0yD":[function(require,module,exports) {
    ...
    var t = function() {
        ...
        function e(n, p) {
            ...
            this.setupCanvasContext = function() {
                ...
                var n;
                r.element = document.querySelector(t), null === (n = r.element) || void 0 === n || n.addEventListener("click", function(t) {
                    var n = new o(2 * t.clientX, 2 * t.clientY); // Set position
                    r.bursts.push(new i(n)); // Add burst
                    e.CONFIG.destroy_target && (r.element.style.visibility = "hidden"); // Hide element
                });
            }, this.setupElementForScroll = function(t) {
                r.element = document.querySelector(t);
                let fired = false;
                window.addEventListener("scroll", function() {
                    if (fired) return;
                    // Check if the element is within 10% bounds of the viewport (top and bottom)
                    var rect = r.element.getBoundingClientRect(); // Get the location of the element on the page
                    if (rect.top < window.innerHeight * 0.8 && rect.bottom > window.innerHeight * 0.2) {
                        setTimeout(function() {
                            rect = r.element.getBoundingClientRect(); // Get the location of the element on the page
                            var n = new o(2 * (rect.x + rect.width / 2), 2 * (rect.y + rect.height / 2)); // Set position
                            r.bursts.push(new i(n)); // Add burst
                            e.CONFIG.destroy_target && (r.element.style.visibility = "hidden"); // Hide element
                        }, 500);
                        fired = true;
            ...
            }, !n) throw new Error("Missing element selector");
            e.CONFIG || (e.CONFIG = new t), this.time = (new Date).getTime(), this.delta_time = 0, this.setupCanvasContext(), p === "scroll" ? this.setupElementForScroll(n) : this.setupElement(n), window.requestAnimationFrame(this.update);
        }
        return e.prototype.draw = function() {
            s.clearScreen();
            for(var t = 0, e = this.bursts; t < e.length; t++)e[t].draw();
        }, e;
    }(), i = function() {
        function t(t) {
            this.particles = [];
...
window.addEventListener("load", ()=>{
    const confetti = new Confetti(".card-step.stylised", "click");
...
},{}],"arE4d":[function(require,module,exports) {
document.addEventListener("DOMContentLoaded", function() {
