...
window.addEventListener('DOMContentLoaded', () => {
    ...
    gltfLoader.load(
        // resource URL
        bedroom_model,
        // 'https://cdn.growmybusiness.co.nz/libraries/three-assets/bedroom.glb',
        ...
        function ( gltf ) {
            ...
            gltf_scene.position.set(0, 4, 0);
            gltf_scene.rotation.set(0, 0, 0);

            model = gltf_scene.children[0];

            const texture = exrLoader.load(HDRI);
    ...
    gltfLoader.load(
        // resource URL
        // 'public/bedroom/bedroom.gltf',
        'https://cdn.growmybusiness.co.nz/libraries/three-assets/skybox.glb',
        // called when the resource is loaded
        function ( glb ) {
            skybox = glb.scene;
            scene.add( skybox );
    ...
    function add_toon_torus () {
        const texture = new THREE.TextureLoader().load(TOON_TONE);
